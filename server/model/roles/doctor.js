...
class Doctor extends Role {
    constructor(room, player) {
        super('Doctor', 'You can choose a person to heal every night, protecting them from attacks.', 'town', 'At night, use /c playerName to choose who to heal.', room, player, 0);
    }
