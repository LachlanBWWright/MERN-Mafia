...
class MafiaInvestigator extends RoleMafia {
    constructor(room, player) {
        super('Mafia Investigator', 'mafia', room, player, 0, false, false, false, false, false, true, false, true);
        this.attackVote;
    }
    ...
    defaultVisit() { //This visits a role and attacks them. this.visiting is dictated by the faction Class.
        if(this.visiting != null) {
            ...
            this.room.io.to(this.player.socketId).emit('receive-message', (this.visiting.player.playerUsername + '\'s role is ' + this.visiting.name + '.'));            
        }
    }
